...
$ost->addExtraHeader('<script type="text/javascript" src="js/ticket.js?b42ddc7"></script>');
$ost->addExtraHeader('<script type="text/javascript" src="js/thread.js?b42ddc7"></script>');
